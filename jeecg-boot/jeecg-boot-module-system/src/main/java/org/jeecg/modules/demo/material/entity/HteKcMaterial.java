 ...
 */
@Data
@TableName("hte_kc_material")
@ApiModel(value="hte_kc_material对象", description="库存原料表")
public class HteKcMaterial implements Serializable {
